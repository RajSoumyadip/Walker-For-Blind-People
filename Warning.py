  ...
  with tf.Session(graph=detection_graph) as sess:
    while True:
      ...
      for i,b in enumerate(boxes[0]):
        #                 car                    bus                  truck                person                  bench                bicycle                 bike
        if classes[0][i] == 3 or classes[0][i] == 6 or classes[0][i] == 8 or classes[0][i] == 1 or classes[0][i] == 14 or classes[0][i] == 2 or classes[0][i] == 4:
          if scores[0][i] >= 0.5:
